...
public class CodeDelete {
	...
	public ConfigModel loadXml(String xmlPath)throws Exception{
		// xsd文件路径
		String xsdPath=new File("").getAbsolutePath()+"\\src\\resources\\codegen.xsd";
		System.out.print("文件路径是:"+xsdPath);
		// 验证XML
	...
	public  void deleteFileByConfig(ConfigModel configModel)throws Exception{
		...
		for(ConfigModel.Table table:tableList){
			...
			if(subtables!=null&& subtables.size()!=0){
				for(ConfigModel.Table.SubTable subtable:subtables){
	...
	public void execute() throws Exception {
        ...
        if(xmlPath==null||xmlPath==""){
        	setXmlPath(dir+"\\"+"src\\resources\\codegenconfig.xml");
        }
